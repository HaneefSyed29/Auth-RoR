...
class ProgressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create progress" do
    assert_difference("Progress.count") do
      post progresses_url, params: { progress: { caption: @progress.caption, title: @progress.title } }
    end
  ...
  test "should update progress" do
    patch progress_url(@progress), params: { progress: { caption: @progress.caption, title: @progress.title } }
